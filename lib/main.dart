...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: Color.fromARGB(255, 10, 26, 33),
        scaffoldBackgroundColor: Color.fromARGB(255, 10, 28, 33),
        appBarTheme: AppBarTheme(
          backgroundColor: Color.fromARGB(255, 10, 26, 33),
        ),
      ),
      home: InputPage(),
    );
...
const kActiveCardColour = Color.fromARGB(255, 8, 106, 136);
const kInactiveCardColour = Color.fromARGB(255, 201, 44, 104);
const kBottomContainerColour = Color.fromARGB(255, 21, 185, 235);
